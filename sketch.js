...
if(keyDown("space")){
    ...
    if(keyDown("M")){
      monsterGroup.setVelocityXEach(monsterGroup.velocityX+0.1)
    }
    if(keyDown("2")){
      Mobter()
    }
...
function fruits(){
  ...
  //Increase the velocity of fruit after score 4 
    ...
    if (r == 1) {
      ...
      fruit.x=Math.round(random(100,550));
    } else if (r == 2) {
